...
export default function CreateLiveModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Iniciar Nova Live">
      ...
      >
        {/* Header Visual */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-orange-500 to-amber-500 p-6 text-white">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex-1 py-3 px-6 bg-gradient-to-r from-primary to-orange-500 text-white font-semibold rounded-xl flex items-center justify-center gap-2 shadow-lg hover:shadow-primary/30 transition-shadow"
          >
